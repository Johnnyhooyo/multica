...
type Task struct {
	...
	HandoffNote                   string                 `json:"handoff_note,omitempty"`                     // server-authored run context (assignment handoff or delegated-chat completion); rendered separately from member-authored ChatMessage
